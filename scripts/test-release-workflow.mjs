 ...
 *
 * Options:
 *   --packages <packages>    Comma-separated list of packages to test (default: @recursica/figma-plugin,@recursica/figma-plugin-test,@recursica/adapter-common,@recursica/schemas)
 ...
 * - NPM Libraries (@recursica/adapter-common, @recursica/schemas): No publish commands, handled by Changesets only
 *
 * Requirements:
...
function showHelp() {
  ...
  log(
    "                          (default: @recursica/figma-plugin,@recursica/figma-plugin-test,@recursica/adapter-common,@recursica/schemas)",
    "cyan",
  );
  log(
