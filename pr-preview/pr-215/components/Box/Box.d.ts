...
import { RecursicaBorderRadiusType } from '../../recursica/RecursicaBorderRadiusType';
import { BoxProps as MantineBoxProps, StyleProp } from '@mantine/core';
...
export type BorderStyle = "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset" | "none" | "hidden";
...
export interface BoxProps extends BoxColors, BoxMargins, BoxPaddings, BoxBorders, PositionProps, BoxSizes {
    /** Children */
...
export declare const Box: import('../../../../../node_modules/react').ForwardRefExoticComponent<BoxProps & import('../../../../../node_modules/react').RefAttributes<HTMLDivElement>>;
