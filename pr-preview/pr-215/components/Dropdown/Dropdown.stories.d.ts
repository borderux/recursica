...
declare const meta: {
    title: string;
    component: import('../../../../../node_modules/react').ForwardRefExoticComponent<Pick<import('@mantine/core').SelectProps, "disabled" | "defaultValue" | "onChange" | "value" | "placeholder" | "error" | "readOnly"> & {
