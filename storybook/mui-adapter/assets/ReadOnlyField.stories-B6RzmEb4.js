...
}`,...(L=(j=o.parameters)==null?void 0:j.docs)==null?void 0:L.source},description:{story:"Validates the core read-only label execution and base default spacing bindings globally.",...(B=(V=o.parameters)==null?void 0:V.docs)==null?void 0:B.description}}};var I,N,A,P,W;l.parameters={...l.parameters,docs:{...(I=l.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    formLayout: "side-by-side",
    value: "Some fixed readable text mapping horizontally"
  }
}`,...(A=(N=l.parameters)==null?void 0:N.docs)==null?void 0:A.source},description:{story:"Binds side-by-side structures globally maintaining correct inline gutter layouts.",...(W=(P=l.parameters)==null?void 0:P.docs)==null?void 0:W.description}}};var _,K,q,z,H;i.parameters={...i.parameters,docs:{...(_=i.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    labelWithEditIcon: true,
    required: true,
    value: "Editable fixed structure"
  }
}`,...(q=(K=i.parameters)==null?void 0:K.docs)==null?void 0:q.source},description:{story:"Tests the fallback structural logic when Edit icon natively overrides required bindings.",...(H=(z=i.parameters)==null?void 0:z.docs)==null?void 0:H.description}}};var Y,U,Z,G,J;d.parameters={...d.parameters,docs:{...(Y=d.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {},
  render: () => <div style={{
    display: "flex",
...
Currently, all types safely default to string extraction mapping into the text renderer natively.`,...(J=(G=d.parameters)==null?void 0:G.docs)==null?void 0:J.description}}};const ce=["Default","EmptyValue","CustomEmptyText","CustomEmptyRenderer","StackedDefault","SideBySide","WithEditIcon","DataTypes"];export{n as CustomEmptyRenderer,s as CustomEmptyText,d as DataTypes,t as Default,r as EmptyValue,l as SideBySide,o as StackedDefault,i as WithEditIcon,ce as __namedExportsOrder,pe as default};
