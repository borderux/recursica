import{j as n}from"./iframe-BM_dDOh_.js";import{B as a}from"./Box-Z1coEZVm.js";import"./preload-helper-Dp1pzeXC.js";import"./Box-DWget39K.js";import"./generateUtilityClasses-DDbjFgb8.js";import"./generateUtilityClass-BtcU_pBl.js";const T={title:"UI-Kit/Box",component:a,tags:["autodocs"],parameters:{docs:{description:{component:"The `Box` component is the foundational layout primitive. It accepts all standard MUI layout properties (like `m`, `mt`, `p`, `px`, etc.), but natively intercepts **Recursica Spacing Tokens** (e.g., `rec-none`, `rec-sm`, `rec-default`, `rec-md`, `rec-lg`, `rec-xl`, `rec-2xl`). This allows developers to use Recursica's strict design tokens seamlessly alongside standard MUI spacing."}},controls:{include:["layer","withLayer","children","component","variant","size","icon","disabled","href","onClick","onChange","value","checked"]}}},e={args:{children:"This is a standard Box",m:"20px"},render:o=>n.jsx(a,{...o,style:{border:"1px solid gray",padding:"10px"}})},r={args:{children:"This Box uses Recursica layout tokens",m:"rec-xl",p:"rec-md"},render:o=>n.jsx("div",{style:{border:"1px dashed #ccc",display:"inline-block"},children:n.jsx(a,{...o,style:{backgroundColor:"rgba(0,0,0,0.1)"}})})},s={args:{component:"section",children:"This Box is rendered as a <section> element",m:"rec-default",p:"rec-lg"}};var c,t,i;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
...
}`,...(g=(u=s.parameters)==null?void 0:u.docs)==null?void 0:g.source}}};const f=["Default","WithRecursicaTokens","Polymorphic"];export{e as Default,s as Polymorphic,r as WithRecursicaTokens,f as __namedExportsOrder,T as default};
