...
// Reference Files Messages
export interface LoadReferenceFilesMessage extends BaseMessage {
  type: "load-reference-files";
}

export interface ReferenceFilesLoadedResponse extends BaseMessage {
...
export interface AddReferenceFileMessage extends BaseMessage {
  type: "add-reference-file";
}

export interface ReferenceFileAddedResponse extends BaseMessage {
...
export interface RemoveReferenceFileMessage extends BaseMessage {
  type: "remove-reference-file";
  fileKey: string;
}

export interface AddReferenceFileManualMessage extends BaseMessage {
...
export interface ReferenceFileRemovedResponse extends BaseMessage {
...
export type PluginMessage =
  ...
  | LoadReferenceFilesMessage
  | AddReferenceFileMessage
  | AddReferenceFileManualMessage
  | RemoveReferenceFileMessage
...
export type PluginResponse =
  ...
  | ReferenceFilesLoadedResponse
  | ReferenceFileAddedResponse
  | ReferenceFileRemovedResponse
  | ErrorMessage;
