# Recursica Internal Tool - Dist Update Script (PowerShell)
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Recursica Internal Tool - Dist Update Script" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$baseUrl = "https://raw.githubusercontent.com/borderux/recursica/main/apps/recursica-internal-tool/dist"
$files = @("recursica-internal-tool.js", "index.html", "vite.svg")
